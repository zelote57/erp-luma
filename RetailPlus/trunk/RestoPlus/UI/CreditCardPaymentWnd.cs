...
namespace AceSoft.RetailPlus.Client.UI
{
	public class CreditCardPaymentWnd : Form
	{
        ...
        private void cboCardType_GotFocus(object sender, System.EventArgs e)
        {
        ...
        private void txtCardNo_GotFocus(object sender, System.EventArgs e)
        {
            keyboardNoControl1.Visible = false;
            keyboardSearchControl1.Visible = true;
            txtSelectedTexBox = (TextBox)sender;
        }
        private void txtCardHolder_GotFocus(object sender, System.EventArgs e)
        {
            keyboardNoControl1.Visible = false;
            keyboardSearchControl1.Visible = true;
            txtSelectedTexBox = (TextBox)sender;
        }
        private void txtValidityDates_GotFocus(object sender, System.EventArgs e)
        {
            keyboardNoControl1.Visible = true;
            keyboardSearchControl1.Visible = false;
            txtSelectedTexBox = (TextBox)sender;
        ...
        private void keyboardSearchControl1_UserKeyPressed(object sender, AceSoft.KeyBoardHook.KeyboardEventArgs e)
        {
            if (txtSelectedTexBox == null)
                txtCardNo.Focus();
            else if (txtSelectedTexBox.Name == txtCardNo.Name)
                txtCardNo.Focus();
            else if (txtSelectedTexBox.Name == txtCardHolder.Name)
                txtCardHolder.Focus();
        ...
        private void keyboardNoControl1_UserKeyPressed(object sender, AceSoft.KeyBoardHook.KeyboardEventArgs e)
        {
            if (txtSelectedTexBox == null)
                ...
                txtAmount.Focus();
            else if (txtSelectedTexBox.Name == txtValidityDates.Name)

						    ...
						    <table class="ms-toolbar" cellspacing="0" cellpadding="2" border="0">
							    <tr>
								    <td class="ms-toolbar" align="center">
									    <table cellspacing="0" cellpadding="1" border="0">
										    <tr>
											    <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgSave" title="Save the receipt format" accessKey="V" tabIndex="1" runat="server" CssClass="ms-toolbar" ImageUrl="../../../_layouts/images/newuser.gif" alt="Save the receipt format" border="0" width="16" height="16"></asp:imagebutton>&nbsp;
											    </td>
											    <td nowrap="nowrap"><asp:linkbutton id="cmdSave" title="Save the receipt format" accessKey="N" tabIndex="2" runat="server" CssClass="ms-toolbar" onclick="cmdSave_Click">Save the receipt format</asp:linkbutton></td>
										    </tr>
									    </table>
								    </td>
							    </tr>

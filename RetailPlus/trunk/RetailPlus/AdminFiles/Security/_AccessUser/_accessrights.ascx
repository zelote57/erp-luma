			...
			<table class="ms-toolbar" style="margin-left: 0px" cellpadding="2" cellspacing="0" border="0" width="100%">
				<tr>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap">Reload access to group </td>
								<td nowrap="nowrap">
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
							    <td nowrap="nowrap"><asp:imagebutton accessKey="C" id="imgReload" title="Reload Now" tabIndex="3" height="16" width="16" border="0" alt="Reload Now" ImageUrl="../../../_layouts/images/impitem.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgReload_Click"></asp:imagebutton></td>
								<td class="ms-toolbar" nowrap="nowrap">Reload to previous settings </td>
							</tr>
						</table>
					</td>
					<td class="ms-separator">|</td>

...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Security._AccessUser._Default" Codebehind="Default.aspx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlAccount" Src="_Account.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlAccessRights" Src="_AccessRights.ascx" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlMenu" Src="../../../AdminFiles/_Menu.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RetailPlus : Access Users</title>
						...
						<TABLE class="ms-tztable" id="ZoneTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" vAlign="top" width="100%">
									...
									<CTRL:ctrlAccessRights id="ctrlAccessRights" runat="server" Visible="False"></CTRL:ctrlAccessRights>
									<CTRL:ctrlAccount id="ctrlAccount" runat="server" Visible="False"></CTRL:ctrlAccount>

...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Security._Terminals._Default" Codebehind="Default.aspx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlUpdate" Src="_Update.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlUpdateRewards" Src="_UpdateRewards.ascx" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Terminals</title>
						...
						<TABLE class="ms-tztable" id="ZoneTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" vAlign="top" width="100%">
									...
									<CTRL:ctrlUpdateRewards id="ctrlUpdateRewards" runat="server" Visible="False"></CTRL:ctrlUpdateRewards>
								</td>
							</tr>
						</TABLE>
					</TD>

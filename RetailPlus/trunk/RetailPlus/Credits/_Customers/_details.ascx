...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
    ...
    <tr>
		...
		<td id="AddUserTextTDID2">
			...
			<table class="ms-toolbar" id="onetidGrpsTC" style="margin-left: 0px" cellpadding="2" cellspacing="0" border="0" width="100%">
				<tr>
					<td class="ms-toolbar" align="left" nowrap="nowrap">
						<table cellspacing="0" cellpadding="1" border="0" >
							<tr>
					...
					<td class="ms-toolbar" id="align052" nowrap="nowrap" align="right" width="99%"><img height="1" alt="" src="../../_layouts/images/blank.gif" width="1" />
					</td>
				</tr>
			</table>
		</td>

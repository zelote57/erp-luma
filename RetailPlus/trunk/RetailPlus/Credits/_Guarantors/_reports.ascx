<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.Credits._Guarantors.__Reports" Codebehind="_Reports.ascx.cs" %>
    ...
    <tr>
		...
		<td class="ms-authoringcontrols">
		    <table class="ms-authoringcontrols" style="MARGIN-BOTTOM: 5px" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
					<td style="padding-bottom:2px" nowrap="nowrap">
						&nbsp;<asp:Label id="lblTrxStartDate" runat="server">Guarantor Card Expiry Date From</asp:Label>&nbsp;
					</td>
					<td class="ms-separator">&nbsp;&nbsp;&nbsp;</td>
					<td nowrap="nowrap">
					...
					<td class="ms-separator">&nbsp;&nbsp;|&nbsp;&nbsp;</td>
					<td style="padding-bottom:2px" nowrap="nowrap">
						<asp:Label id="lblTrxEndDate" runat="server">Guarantor Card Expiry Date To</asp:Label>
					</td>
					<td class="ms-separator">&nbsp;&nbsp;&nbsp;</td>
					<td nowrap="nowrap">
                ...
                <tr>
					...
					<td class="ms-separator">&nbsp;&nbsp;|&nbsp;&nbsp;</td>
					<td style="padding-bottom:2px" nowrap="nowrap">
						<asp:Label id="lblShowDetails" runat="server">Show members in the report</asp:Label>
					</td>
					<td class="ms-separator">&nbsp;&nbsp;&nbsp;</td>
					<td nowrap="nowrap">

...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Credits._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Credits</title>
						...
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%">
									<CTRL:ctrlDefault id="ctrlDefault" runat="server" Visible="False"></CTRL:ctrlDefault></td>
							</tr>
						</table>
					</td>
				</tr>

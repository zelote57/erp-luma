...
namespace AceSoft.RetailPlus.GeneralLedger._AccountCategory
{
	...
	public partial class _Default : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			const string defaultTitle = "Account Categories.";
			SiteTitle.Title = defaultTitle;

			const SearchCategoryID defaultSearchIndex = SearchCategoryID.AccountCategory;
			...
			if (Request.QueryString["task"]!=null)
			{
				...
				{
					case "add":
						stHeading = "Create New Account Category";	
						ctrlInsert.Visible = true;
						break;
					case "edit":
						stHeading = "Modify Account Category";
						ctrlUpdate.Visible = true;
						break;   
					case "list":
						stHeading = "Account Category List";		

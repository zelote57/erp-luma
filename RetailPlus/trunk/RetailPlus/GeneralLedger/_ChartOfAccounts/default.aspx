<%@ Page language="c#" Inherits="AceSoft.RetailPlus.GeneralLedger._ChartOfAccounts._Default" Codebehind="Default.aspx.cs" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlBalanceSheet" Src="_BalanceSheet.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlGeneralLedger" Src="_GeneralLedger.ascx" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Chart of Accounts</title>
						...
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%">
									<CTRL:ctrlList id="ctrlList" runat="server" Visible="False"/>
									<CTRL:ctrlInsert id="ctrlInsert" runat="server" Visible="False"/>
									<CTRL:ctrlUpdate id="ctrlUpdate" runat="server" Visible="False"/>
									<CTRL:ctrlReports ID="ctrlReports" runat="server" Visible="False"/>
									<CTRL:ctrlBalanceSheet ID="ctrlBalanceSheet" runat="server" Visible="False"/>
									<CTRL:ctrlGeneralLedger ID="ctrlGeneralLedger" runat="server" Visible="False"/></td>
							</tr>
						</table>

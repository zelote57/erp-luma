						...
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								...
								<td class="ms-toolbar">
									<table cellSpacing="0" cellPadding="1" border="0">
										<tr>
											<td class="ms-toolbar" noWrap style="height: 21px"><asp:imagebutton id="imgPost" title="Post Invoice" accessKey="P" tabIndex="3" height="16" width="16" border="0" alt="Post Invoice" ImageUrl="../../_layouts/images/delitem.gif" runat="server" CssClass="ms-toolbar" OnClick="imgPost_Click"></asp:imagebutton></td>
											<td noWrap style="height: 21px"><asp:linkbutton id="cmdPost" title="Post Invoice" accessKey="P" tabIndex="4" runat="server" CssClass="ms-toolbar" onclick="cmdPost_Click">Post Invoice</asp:linkbutton></td>
										</tr>
									</table>
								</td>
							</tr>

<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.GeneralLedger._Payments.__Update" Codebehind="_Update.ascx.cs" %>
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="ms-descriptiontext" style="padding-bottom: 10px; PADDING-TOP: 8px" colspan="3"><font color="red">*</font>
						Indicates a required field<asp:label id="lblReferrer" runat="server"></asp:label><asp:label id="lblPaymentID" runat="server" Visible="False"></asp:label>
					</td>
				</tr>
				<tr>
						...
						<table class="ms-authoringcontrols" cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<tr style="padding-bottom: 5px">
								...
								<td style="padding-bottom: 2px" width="30%"><asp:TextBox id="txtChequeDate" runat="server" CssClass="ms-short" ToolTip="Double Click to Select Date From Calendar" ondblclick="ontime(this)"></asp:TextBox>
                                    ...
                                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtChequeDate"
						...
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								...
								<td class="ms-toolbar">
									<table cellspacing="0" cellpadding="1" border="0">
										<tr>
											<td class="ms-toolbar" nowrap="nowrap" style="height: 21px"><asp:imagebutton id="imgPost" title="Post Invoice" accessKey="P" tabIndex="3" height="16" width="16" border="0" alt="Post Invoice" ImageUrl="../../_layouts/images/delitem.gif" runat="server" CssClass="ms-toolbar" OnClick="imgPost_Click"></asp:imagebutton></td>
											<td nowrap="nowrap" style="height: 21px"><asp:linkbutton id="cmdPost" title="Post Invoice" accessKey="P" tabIndex="4" runat="server" CssClass="ms-toolbar" onclick="cmdPost_Click">Post Invoice</asp:linkbutton></td>
										</tr>
									</table>
								</td>
							</tr>

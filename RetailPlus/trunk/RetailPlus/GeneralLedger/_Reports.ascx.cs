...
namespace AceSoft.RetailPlus.GeneralLedger
{
	...
	public partial  class __Reports : System.Web.UI.UserControl
	{
		...
		private void GenerateWord()
		{
			...
			string strFileName = "po_" + Session["UserName"].ToString() + "_" + DateTime.Now.ToString("yyyyMMddhhmmssff") + ".doc";
			if (System.IO.File.Exists(strPath + strFileName))
				System.IO.File.Delete(strPath + strFileName);
		...
		private void GenerateExcel()
		{
			...
			string strFileName = "po_" + Session["UserName"].ToString() + "_" + DateTime.Now.ToString("yyyyMMddhhmmssff") + ".xls";
			if (System.IO.File.Exists(strPath + strFileName))
				System.IO.File.Delete(strPath + strFileName);
...
//			DeleteTempDirectory(strPath);
			...
			string strFileName = "po_" + Session["UserName"].ToString() + "_" + DateTime.Now.ToString("yyyyMMddhhmmssff") + ".htm";
			if (System.IO.File.Exists(strPath + strFileName))
				System.IO.File.Delete(strPath + strFileName);

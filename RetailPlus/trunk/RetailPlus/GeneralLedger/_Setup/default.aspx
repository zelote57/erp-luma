...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.GeneralLedger._Setup._Default" Codebehind="Default.aspx.cs" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlMenu" Src="../../GeneralLedger/_Menu.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlPostingDates" Src="_PostingDates.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlLinkAccountsAP" Src="_LinkAccountsAP.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlProductFinancialSetup" Src="_ProductFinancialSetup.ascx" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : General Ledger</title>
						...
						<TABLE class="ms-tztable" id="ZoneTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" vAlign="top" width="100%">
									<CTRL:ctrlPostingDates id="ctrlPostingDates" runat="server" Visible="False"></CTRL:ctrlPostingDates>
									<CTRL:ctrlLinkAccountsAP id="ctrlLinkAccountsAP" runat="server" Visible="False"></CTRL:ctrlLinkAccountsAP>
									<CTRL:ctrlProductFinancialSetup id="ctrlProductFinancialSetup" runat="server" Visible="False"></CTRL:ctrlProductFinancialSetup>
									</td>
							</tr>
						</TABLE>
					</TD>

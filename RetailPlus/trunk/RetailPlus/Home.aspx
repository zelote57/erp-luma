...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus._Home" Codebehind="Home.aspx.cs" %>
...
<HTML>
	...
	<BODY id="PageBody" scroll="yes" marginheight="0" marginwidth="0">
		<FORM id="frmDefaultID" name="frmDefault" action="home.aspx" method="post" runat="server">

<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Home.GLA._Default" Codebehind="Default.aspx.cs" %>
...
<%@ Register TagPrefix="CtrL" TagName="ctrlUploadSales" Src="_UploadSales.ascx" %>
<%@ Reference Page="~/adminfiles/default.aspx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//Dtd HTML 4.0 transitional//EN" >
<HTML>
	<HEAD>
		<title>RetailPlus : GLA Home</title>
						...
						<table class="ms-tztable" id="Zonetable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%" style="height: 217px">
                                    ...
                                    <CtrL:ctrlUploadSales id="ctrlUploadSales" runat="server" ></CtrL:ctrlUploadSales>
                                </td>
							</tr>
						</table>

...
namespace AceSoft.RetailPlus.Inventory._BranchTransfer
{
	public partial class _Default : System.Web.UI.Page
	{
		...
		{
			const string defaultHeading = "Branch Transfer";
			string stHeading = defaultHeading;

            const string defaultTitle = "Issue Inventory Branch Transfers";
            ...
            if (Request.QueryString["task"] != null)
            {
                ...
                else
                {
                    ...
                    {
                        case "list":
                            stHeading = "Branch Transfer list";
                            SearchIndex = SearchCategoryID.NotApplicable;
                            ctrlList.Visible = true;
                            break;
                        case "add":
                            stHeading = "Add new branch transfer";
                            SearchIndex = SearchCategoryID.NotApplicable;
                            ctrlInsert.Visible = true;
                            break;
                        case "edit":
                            stHeading = "Update open branch transfer";
                            SearchIndex = SearchCategoryID.NotApplicable;
                        ...
                        case "additem":
                            ...
                            break;
                        case "issuegrn":
                            stHeading = "Issue GRN for Branch Transfers";
                            SearchIndex = SearchCategoryID.NotApplicable;
                            ctrlPost.Visible = true;
                            break;
                        case "details":
                            stHeading = "Branch Transfer Details";
                            SearchIndex = SearchCategoryID.NotApplicable;

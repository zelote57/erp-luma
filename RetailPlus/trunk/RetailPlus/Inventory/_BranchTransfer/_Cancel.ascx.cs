namespace AceSoft.RetailPlus.Inventory._BranchTransfer
{
	...
	public partial  class __Cancel : System.Web.UI.UserControl
	{
        ...
        protected void cmdCancelBranchTransfer_Click(object sender, System.EventArgs e)
        {
            CancelBranchTransfer();
        }

        protected void imgCancelBranchTransfer_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            CancelBranchTransfer();
        }

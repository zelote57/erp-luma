					...
					<td class="ms-toolbar">
                        <asp:UpdatePanel ID="updCancel" runat="server">
                            <ContentTemplate>
						        <table cellspacing="0" cellpadding="1" border="0">
							        <tr>
								        <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgCancelBranchTransfer" title="Cancel This Branch Transfer" accessKey="I" tabIndex="5" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/cancel.gif" alt="Cancel this branch transfer" border="0" width="16" height="16" OnClick="imgCancelBranchTransfer_Click"></asp:imagebutton></td>
								        <td nowrap="nowrap"><asp:linkbutton id="cmdCancelBranchTransfer" title="Cancel this branch transfer" accessKey="I" tabIndex="6" CssClass="ms-toolbar" runat="server" onclick="cmdCancelBranchTransfer_Click">Cancel BranchTransfer</asp:linkbutton></td>
							        </tr>
						        </table>
                            </ContentTemplate>
                        </asp:UpdatePanel>

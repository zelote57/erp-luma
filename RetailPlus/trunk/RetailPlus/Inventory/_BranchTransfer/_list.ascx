<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.Inventory._BranchTransfer.__List" Codebehind="_List.ascx.cs" %>
				        ...
				        <HeaderTemplate>
					        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblHeaderTemplate">
						        ...
						        <TR>
								    ...
								    <TH class="ms-vh2" style="padding-bottom: 4px"></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByBranchTransferNo" runat="server">BranchTransfer No.</asp:hyperlink></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByBranchTransferDate" runat="server">Transfer Date</asp:hyperlink></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByBranchCodeFrom" runat="server">Branch From</asp:hyperlink></TH>
								    <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByBranchCodeTo" runat="server">Deliver to Branch</asp:hyperlink></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByReqDeliveryDate" runat="server">Req Delivery Date</asp:hyperlink></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
								        <asp:hyperlink id="SortByBranchTransferSubTotal" runat="server">Amount</asp:hyperlink></TH>
							        <TH class="ms-vh2" style="padding-bottom: 4px">
							        </TH>
						        </TR>
					        </table>
				        ...
				        <ItemTemplate>
					        <TABLE id="tblItemTemplate" cellSpacing="0" cellPadding="0" width="100%" border="0" onmouseover="this.bgColor='#FFE303'" onmouseout="this.bgColor='transparent'">
						        ...
						        <TR>
							        ...
							        <TD class="ms-vb-user">
								        <asp:HyperLink id="lnkBranchTransferNo" runat="server"></asp:HyperLink>
							        </TD>
							        <TD class="ms-vb-user">
								        <asp:Label ID="lblBranchTransferDate" Runat="server"></asp:Label>
							        </TD>
							        <TD class="ms-vb-user">
							        ...
							        <TD class="ms-vb-user">
								        <asp:Label ID="lblBranchTransferSubTotal" Runat="server"></asp:Label>
							        </TD>
							        <TD class="ms-vb2">
							                ...
							                <asp:panel id="panItem" runat="server" Width="100%" Height="100%" >
								                <TABLE id="tblpanItem" cellSpacing="0" cellPadding="0" width="100%" border="0">
									                ...
									                <TR>
										                ...
										                <TD width="80%">
								                            <asp:Label ID="lblBranchTransferRemarks" CssClass="ms-vh2" Runat="server"></asp:Label>
										                </TD>
									                </TR>
								                </TABLE>
							                </asp:panel></DIV>

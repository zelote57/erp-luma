					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								...
								<td noWrap><asp:linkbutton id="cmdCancel" title="Cancel trasnfering to other branch" accessKey="C" tabIndex="4" CausesValidation="False" CssClass="ms-toolbar" runat="server" onclick="cmdCancel_Click">Cancel</asp:linkbutton></td>
							</tr>
						</table>
					</td>
			...
			<table class="ms-toolbar" id="onetidGrpsTC" style="MARGIN-LEFT: 0px" cellpadding="2" cellspacing="0" border="0" width="100%">
				<TR>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:label id="Label4" runat="server" Visible="true">Select branch to transfer to :</asp:label><asp:dropdownlist id="cboBranch" runat="server"></asp:dropdownlist></td>
								<td noWrap><asp:imagebutton id="imgTransfer" title="Create file for transfer to other branch." accessKey="T" tabIndex="3" CausesValidation="False" CssClass="ms-toolbar" runat="server" ImageUrl="/RetailPlus/_layouts/images/impitem.gif" alt="Create file for transfer to other branch." border="0" width="16" height="16"></asp:imagebutton>
					...
					<td class="ms-toolbar" id="align03" noWrap align="right" width="99%"><IMG height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="1">
					</td>
				</TR>
			</TABLE>
		</TD>

...
<%@ Register TagPrefix="CTRL" TagName="ctrlAddItem" Src="_AddItem.ascx" %>
<%@ Register TagPrefix="CTRL" TagName="ctrlTransfer" Src="_Transfer.ascx" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlUpload" Src="_Upload.ascx" %>
...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Inventory._Stock._Default" Codebehind="Default.aspx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RetailPlus : Stocks</title>
								...
								<TR>
									<TD>
										<table style="PADDING-LEFT: 2px; PADDING-TOP: 0px" cellSpacing="0" cellPadding="0" border="0" width="100%">
											<TR>
												<TD style="PADDING-TOP: 2px" noWrap align="center" width="132" height="46"><IMG id="spsPageTitleIcon" alt="" src="../../_layouts/images/Settings.gif">
												</TD>
						...
						<TABLE class="ms-tztable" id="ZoneTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" vAlign="top" width="100%">
									...
									<CTRL:ctrlAddItem id="ctrlAddItem" runat="server" Visible="False"></CTRL:ctrlAddItem>
									<CTRL:ctrlTransfer id="ctrlTransfer" runat="server" Visible="False"></CTRL:ctrlTransfer>
									<CTRL:ctrlUpload id="ctrlUpload" runat="server" Visible="False"></CTRL:ctrlUpload>
									<CTRL:ctrlDetails id="ctrlDetails" runat="server" Visible="False"></CTRL:ctrlDetails>
									<CTRL:ctrlReports id="ctrlReports" runat="server" Visible="False"></CTRL:ctrlReports></td>
							</tr>
						</TABLE>
					</TD>
				</TR>

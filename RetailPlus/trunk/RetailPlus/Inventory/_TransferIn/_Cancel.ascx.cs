namespace AceSoft.RetailPlus.Inventory._TransferIn
{
	...
	public partial  class __Cancel : System.Web.UI.UserControl
	{
        ...
        protected void cmdCancelTransferIn_Click(object sender, System.EventArgs e)
        {
            CancelTransferIn();
        }

        protected void imgCancelTransferIn_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            CancelTransferIn();
        }
        ...
        {
            string stParam = "?task=" + Common.Encrypt("reports", Session.SessionID) + "&target=" + Common.Encrypt("transferin", Session.SessionID) + "&transferinid=" + Common.Encrypt(lblTransferInID.Text, Session.SessionID);

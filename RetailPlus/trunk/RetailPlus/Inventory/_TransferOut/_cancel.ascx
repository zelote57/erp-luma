					...
					<td vAlign="top" colSpan="3">
						<table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr style="PADDING-BOTTOM: auto">
								...
								<td align="right"><asp:textbox onkeypress="AllNum()" id="txtTransferOutDiscountApplied" accessKey="" runat="server" CssClass="ms-short" BorderStyle="Groove" Text=0 Width="82px" Enabled="False"></asp:textbox><asp:dropdownlist id="cboTransferOutDiscountType" runat="server" CssClass="ms-short" Enabled="False">
							...
							<tr style="PADDING-BOTTOM: 5px">
								...
								<td align="right"><asp:textbox onkeypress="AllNum()" id="txtTransferOutFreight" accessKey="" runat="server" CssClass="ms-short" BorderStyle="Groove" Text="0.00" Enabled="False"></asp:textbox>
								                                            </td>
							</tr>
							<tr style="PADDING-BOTTOM: 5px">
								<TD class="ms-formspacer"></TD>
								...
								<td align="right"><asp:textbox onkeypress="AllNum()" id="txtTransferOutDeposit" accessKey="" runat="server" CssClass="ms-short" BorderStyle="Groove" Text="0.00" Enabled="False"></asp:textbox>
								                                               </td>
							</tr>
							<tr>
								<TD class="ms-formspacer"></TD>

...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Inventory._VariationsMatrix._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Inventory Variations Matrix</title>
								...
								<tr>
									<td>
										<table style="padding-left: 2px; padding-TOP: 0px" cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												<td style="padding-TOP: 2px" nowrap="nowrap" align="middle" width="132" height="46"><img id="spsPageTitleIcon" alt="" src="../../_layouts/images/Error.gif">
												</td>
						...
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%">
									<CTRL:ctrlList id="ctrlList" runat="server" Visible="False"></CTRL:ctrlList></td>
							</tr>
						</table>
					</td>
				</tr>

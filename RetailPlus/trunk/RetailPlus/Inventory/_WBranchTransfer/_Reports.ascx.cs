...
namespace AceSoft.RetailPlus.Inventory._WBranchTransfer
{
	...
	public partial  class __Reports : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (!IsPostBack && Visible)
			{
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["reporttype"]))
                    ...
                    lblReportType.Text = "WBranchTransferReport";
                ...
                Session["ReportType"] = "WBranchTransferreport";
            }
        }
        ...
        protected void Page_Init(object sender, System.EventArgs e)
        {
            ...
            {
                if (Session["ReportType"].ToString() == "WBranchTransferreport")
        ...
        private void Export(ExportFormatType pvtExportFormatType)
        {
            ...
            {
                string strFileName = Session["UserName"].ToString() + "_WBranchTransferreport";

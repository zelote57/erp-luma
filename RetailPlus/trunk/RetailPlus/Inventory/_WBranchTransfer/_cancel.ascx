<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.Inventory._WBranchTransfer.__Cancel" Codebehind="_Cancel.ascx.cs" %>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								...
								<td nowrap="nowrap"><asp:linkbutton id="cmdCancel" title="Back To Branch Transfer List" accessKey="C" tabIndex="4" runat="server" CssClass="ms-toolbar" CausesValidation="False" onclick="cmdCancel_Click">Back To Branch Transfer List</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					...
					<td class="ms-toolbar">
                        <asp:UpdatePanel ID="updCancel" runat="server">
                            <ContentTemplate>
						        <table cellspacing="0" cellpadding="1" border="0">
							        <tr>
								        <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgCancelWBranchTransfer" title="Cancel This Branch Transfer" accessKey="I" tabIndex="5" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/cancel.gif" alt="Cancel this branch transfer" border="0" width="16" height="16" OnClick="imgCancelWBranchTransfer_Click"></asp:imagebutton></td>
								        <td nowrap="nowrap"><asp:linkbutton id="cmdCancelWBranchTransfer" title="Cancel this branch transfer" accessKey="I" tabIndex="6" CssClass="ms-toolbar" runat="server" onclick="cmdCancelWBranchTransfer_Click">Cancel WBranchTransfer</asp:linkbutton></td>
							        </tr>
						        </table>
                            </ContentTemplate>
                        </asp:UpdatePanel>

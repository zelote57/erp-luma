...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.Inventory._WBranchTransfer._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Branch / WareHouse Transfer</title>
	...
	<body id="PageBody" scroll="yes" marginheight="0" marginwidth="0">
		<form id="frmDedault" name="frmFedault" action="default.aspx" method="post" runat="server">

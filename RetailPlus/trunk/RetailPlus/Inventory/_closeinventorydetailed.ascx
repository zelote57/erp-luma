<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.Inventory.__CloseInventoryDetailed" Codebehind="_closeinventorydetailed.ascx.cs" %>
                ...
                <tr>
					<td class="ms-authoringcontrols" valign="top" style="PADDING-RIGHT:	10px; BORDER-TOP:	white 10px solid; PADDING-LEFT:	8px; PADDING-BOTTOM:	10px" colspan="3">
                        <table class="ms-authoringcontrols" style="MARGIN-BOTTOM: 5px" cellspacing="0" cellpadding="0" border="0" width="100%">
				            ...
				            <tr>
					            <td style="PADDING-BOTTOM:2px; HEIGHT:15px" nowrap="nowrap">
						            <label>Select Supplier to process</label>
					            </td>
					            <td class="ms-separator" style="HEIGHT: 15px">&nbsp;&nbsp;&nbsp;</td>
					            <td style="HEIGHT: 15px" colspan="3">
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
						                    <asp:dropdownlist id="cboContact" CssClass="ms-long" runat="server" OnSelectedIndexChanged="cboContact_SelectedIndexChanged" AutoPostBack="true" CausesValidation="false"></asp:dropdownlist>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="imgContactCodeSearch" EventName="Click" />
                                        </Triggers>
                                    </asp:UpdatePanel>
					            </td>
                                <td style="PADDING-BOTTOM:2px; HEIGHT:15px" nowrap="nowrap">

...
<HTML>
	<HEAD>
		<title>RetailPlus : Inventory</title>
								...
								<TR>
									<TD>
										<table style="PADDING-LEFT: 2px; PADDING-TOP: 0px" cellSpacing="0" cellPadding="0" border="0" width="100%">
											<TR>
												<TD style="PADDING-TOP: 2px" noWrap align="middle" width="132" height="46"><IMG id="spsPageTitleIcon" alt="" src="../_layouts/images/inventory.gif">
												</TD>
						...
						<TABLE class="ms-tztable" id="ZoneTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" vAlign="top" width="100%" style="height: 217px">
                                    ...
                                    <CTRL:ctrlProductBranchInventoryReport ID="ctrlProductBranchInventoryReport" runat="server" Visible="false" />
                                </td>
							</tr>
						</TABLE>

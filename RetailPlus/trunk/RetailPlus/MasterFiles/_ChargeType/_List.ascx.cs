	...
	public partial  class __List : System.Web.UI.UserControl
	{
        ...
        protected void lstItem_ItemDataBound(object sender, DataListItemEventArgs e)
		{
			...
			else if(e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
                ...
                chkList.Value = dr["ChargeTypeID"].ToString();
				...
				Label lblChargeTypeCode = (Label) e.Item.FindControl("lblChargeTypeCode");
				lblChargeTypeCode.Text = dr["ChargeTypeCode"].ToString();

                HyperLink lnkChargeType = (HyperLink)e.Item.FindControl("lnkChargeType");
                lnkChargeType.Text = dr["ChargeType"].ToString();
                lnkChargeType.NavigateUrl = "Default.aspx?task=" + Common.Encrypt("details", Session.SessionID) + "&id=" + Common.Encrypt(chkList.Value, Session.SessionID);
		...
		private void LoadSortFieldOptions(DataListItemEventArgs e)
		{
			...
			HyperLink SortByChargeTypeCode = (HyperLink) e.Item.FindControl("SortByChargeTypeCode");
			HyperLink SortByChargeType = (HyperLink) e.Item.FindControl("SortByChargeType");
			HyperLink SortByChargeAmount = (HyperLink) e.Item.FindControl("SortByChargeAmount");
			HyperLink SortByInPercent = (HyperLink) e.Item.FindControl("SortByInPercent");

			SortByChargeTypeCode.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ChargeTypeCode", Session.SessionID);
			SortByChargeType.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ChargeType", Session.SessionID);
			SortByChargeAmount.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ChargeAmount", Session.SessionID);
			SortByInPercent.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("InPercent", Session.SessionID);
		}

<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._Contact.__Insert" Codebehind="_Insert.ascx.cs" %>
				...
				<TR>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgSave" ToolTip="Add New Contact" accessKey="S" tabIndex="1" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/saveitem.gif" alt="Save New Contact" border="0" width="16" height="16"></asp:imagebutton>&nbsp;
								</td>
								<td noWrap><asp:linkbutton id="cmdSave" ToolTip="Add New Contact" accessKey="S" tabIndex="2" CssClass="ms-toolbar" runat="server" onclick="cmdSave_Click">Save and New</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgSaveBack" ToolTip="Add New Contact" accessKey="S" tabIndex="1" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/saveitem.gif" alt="Add New Contact" border="0" width="16" height="16"></asp:imagebutton>&nbsp;
								</td>
								<td noWrap><asp:linkbutton id="cmdSaveBack" ToolTip="Add New Contact" accessKey="S" tabIndex="2" CssClass="ms-toolbar" runat="server" onclick="cmdSaveBack_Click">Save and Back</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					<TD class="ms-separator">|</TD>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgCancel" ToolTip="Cancel Adding New Contact" accessKey="C" tabIndex="3" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/impitem.gif" alt="Cancel Adding New Contact" border="0" width="16" height="16" CausesValidation="False"></asp:imagebutton></td>
								<td noWrap><asp:linkbutton id="cmdCancel" ToolTip="Cancel Adding New Contact" accessKey="C" tabIndex="4" CssClass="ms-toolbar" runat="server" CausesValidation="False" onclick="cmdCancel_Click">Cancel</asp:linkbutton></td>
							</tr>
						</table>
					</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="ms-authoringcontrols" width="90%">
                            ...
                            <tr>
                                ...
                                <td class="ms-authoringcontrols">
									...
									<asp:CompareValidator id="CompareValidator6" runat="server" CssClass="ms-error" ErrorMessage="'Terms' must be in number." Display="Dynamic" ControlToValidate="txtTerms" ForeColor=" " Type="Double" Operator="DataTypeCheck"></asp:CompareValidator>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" /></td>
                                <td class="ms-authoringcontrols">
									...
									<asp:CompareValidator id="CompareValidator7" runat="server" CssClass="ms-error" ErrorMessage="'Debit' must be in number." Display="Dynamic" ControlToValidate="txtDebit" ForeColor=" " Type="Double" Operator="DataTypeCheck"></asp:CompareValidator>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" /></td>
                                <td class="ms-authoringcontrols">
									...
									<asp:CompareValidator id="CompareValidator8" runat="server" CssClass="ms-error" ForeColor=" " ControlToValidate="txtCredit" Display="Dynamic" ErrorMessage="'Credit' must be in number." Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="ms-formspacer" height="20">
                            ...
                            <tr>
                                ...
                                <td class="ms-authoringcontrols">
									...
									<asp:CompareValidator id="CompareValidator2" runat="server" CssClass="ms-error" ForeColor=" " ControlToValidate="txtCreditLimit" Display="Dynamic" ErrorMessage="'Credit Limit' must be in number." Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="ms-formspacer" height="20">

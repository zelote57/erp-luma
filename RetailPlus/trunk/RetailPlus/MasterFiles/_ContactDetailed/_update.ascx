<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._ContactDetailed.__Update" Codebehind="_Update.ascx.cs" %>
				...
				<tr>
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgSave" title="Update Customer" accessKey="S" tabIndex="1" height="16" width="16" border="0" alt="Update Customer" ImageUrl="../../_layouts/images/saveitem.gif" runat="server" CssClass="ms-toolbar" OnClick="imgSave_Click"></asp:imagebutton>&nbsp;
								</td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdSave" title="Update Customer" accessKey="S" tabIndex="2" runat="server" CssClass="ms-toolbar" onclick="cmdSave_Click">Save and New</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					...
					<td colspan="3" class="ms-authoringcontrols ms-formwidth" style="PADDING-RIGHT: 10px; BORDER-TOP: white 1px solid; PADDING-LEFT: 8px; padding-bottom: 20px" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" class="ms-authoringcontrols" width="90%">
                            ...
                            <tr>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:textbox id="txtBusinessName" accessKey="G" CssClass="ms-short" runat="server" BorderStyle="Groove" MaxLength="75" style="min-width: 80%"></asp:textbox>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
					...
					<td colspan="3" class="ms-authoringcontrols ms-formwidth" style="PADDING-RIGHT: 10px; BORDER-TOP: white 1px solid; PADDING-LEFT: 8px; padding-bottom: 20px" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" class="ms-authoringcontrols" width="90%">
                            ...
                            <tr>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:TextBox id="txtCity" runat="server" accesskey="G" CssClass="ms-short" MaxLength="30" BorderStyle="Groove"></asp:TextBox>
                                ...
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:TextBox id="txtState" runat="server" accesskey="G" CssClass="ms-short" MaxLength="30" BorderStyle="Groove"></asp:TextBox>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:TextBox id="txtZipCode" runat="server" accesskey="G" CssClass="ms-short" MaxLength="15" BorderStyle="Groove"></asp:TextBox>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
					...
					<td colspan="3" class="ms-authoringcontrols ms-formwidth" style="PADDING-RIGHT: 10px; BORDER-TOP: white 1px solid; PADDING-LEFT: 8px; padding-bottom: 20px" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" class="ms-authoringcontrols" width="90%">
                            ...
                            <tr>
                                ...
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:TextBox id="txtSpouseBirthDate" runat="server" accesskey="G" CssClass="ms-short" MaxLength="10" BorderStyle="Groove" ondblclick="ontime(this)" ToolTip="Double Click to Select Date From Calendar"></asp:TextBox>
                                </td>
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                ...
                                <td class="ms-formspacer"><img src="../../_layouts/images/trans.gif" width="10" alt="" /></td>
                                <td class="ms-authoringcontrols">
                                    <asp:TextBox id="txtAnniversaryDate" runat="server" accesskey="G" CssClass="ms-short" MaxLength="10" BorderStyle="Groove" ondblclick="ontime(this)" ToolTip="Double Click to Select Date From Calendar"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="ms-formspacer" height="20">

...
namespace AceSoft.RetailPlus.MasterFiles._ContactGroup
{
	...
	public partial  class __List : System.Web.UI.UserControl
	{
		...
		private void LoadSortFieldOptions(DataListItemEventArgs e)
		{
			...
			HyperLink SortByContactGroupCode = (HyperLink) e.Item.FindControl("SortByContactGroupCode");
			HyperLink SortByContactGroupName = (HyperLink) e.Item.FindControl("SortByContactGroupName");
			HyperLink SortByContactGroupCategory = (HyperLink) e.Item.FindControl("SortByContactGroupCategory");

			SortByContactGroupCode.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ContactGroupCode", Session.SessionID);
			SortByContactGroupName.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ContactGroupName", Session.SessionID);
			SortByContactGroupCategory.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("ContactGroupCategory", Session.SessionID);
		}

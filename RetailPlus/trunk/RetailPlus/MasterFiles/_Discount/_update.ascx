						...
						<table class="ms-authoringcontrols" style="MARGIN-BOTTOM: 5px" cellSpacing="0" cellPadding="0" border="0" width="100%">
							...
							<tr>
								...
								<td class="ms-authoringcontrols" width="100%">
									...
									<asp:CompareValidator id="CompareValidator2" CssClass="ms-error" runat="server" ControlToValidate="txtDiscountPrice" Display="Dynamic" ErrorMessage="'Discount Price' must be in number." Type="Double" Operator="DataTypeCheck" ForeColor=" "></asp:CompareValidator>
								</td>
							</tr>
							<tr>
								<td class="ms-formspacer"></td>

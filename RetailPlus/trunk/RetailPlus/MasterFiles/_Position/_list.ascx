<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._Position.__List" Codebehind="_List.ascx.cs" %>
				...
				<tr>
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgAdd" ToolTip="Add New Position" accessKey="N" tabIndex="1" height="16" width="16" border="0" alt="Add New Position" ImageUrl="../../_layouts/images/newuser.gif" runat="server" CssClass="ms-toolbar" OnClick="imgAdd_Click"></asp:imagebutton>&nbsp;
								</td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdAdd" ToolTip="Add New Position" accessKey="N" tabIndex="2" runat="server" CssClass="ms-toolbar" onclick="cmdAdd_Click">Add Position</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgDelete" ToolTip="Remove Selected Position" accessKey="X" tabIndex="3" height="16" width="16" border="0" alt="Remove Selected Position" ImageUrl="../../_layouts/images/delitem.gif" runat="server" CssClass="ms-toolbar" OnClick="imgDelete_Click"></asp:imagebutton></td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdDelete" ToolTip="Remove Selected Position" accessKey="X" tabIndex="4" runat="server" CssClass="ms-toolbar" onclick="cmdDelete_Click">Remove Selected Position</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					<td class="ms-separator">
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="idEdit" ToolTip="Edit Selected Position" accessKey="E" tabIndex="5" height="16" width="16" border="0" alt="Edit Selected Position" ImageUrl="../../_layouts/images/edit.gif" runat="server" CssClass="ms-toolbar" OnClick="idEdit_Click"></asp:imagebutton></td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdEdit" ToolTip="Edit Selected Position" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="cmdEdit_Click">Edit Selected Position</asp:linkbutton></td>
							</tr>
						</table>
					</td>
				...
				<HeaderTemplate>
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblHeaderTemplate">
						...
						<tr>
							...
							<TH class="ms-vh2" style="padding-bottom: 4px"></TH>
							<TH class="ms-vh2" style="padding-bottom: 4px">
								<asp:hyperlink id="SortByPositionCode" runat="server">Code</asp:hyperlink></TH>
							<TH class="ms-vh2" style="padding-bottom: 4px">
								<asp:hyperlink id="SortByPositionName" runat="server">Name</asp:hyperlink></TH>
							<TH class="ms-vh2" style="padding-bottom: 4px">
							</TH>
						</tr>
					</table>
				...
				<ItemTemplate>
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblItemTemplate" onmouseover="this.bgColor='#FFE303'" onmouseout="this.bgColor='transparent'">
						...
						<tr>
							...
							<td class="ms-vb-user">
								<asp:Label ID="lblPositionCode" Runat="server"></asp:Label>
							</td>
							<td class="ms-vb-user">
								<asp:HyperLink ID="lnkPositionName" Runat="server"></asp:HyperLink>
							</td>
							<td class="ms-vb2">

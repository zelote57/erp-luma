				...
				<TR>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgAdd" ToolTip="Add New Product Package" accessKey="N" tabIndex="1" height="16" width="16" border="0" alt="Add New Product Package" ImageUrl="../../../_layouts/images/newuser.gif" runat="server" CssClass="ms-toolbar"></asp:imagebutton>&nbsp;
								</td>
					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgDelete" ToolTip="Remove Selected Product Package" accessKey="X" tabIndex="3" height="16" width="16" border="0" alt="Remove Selected Product Package" ImageUrl="../../../_layouts/images/delitem.gif" runat="server" CssClass="ms-toolbar"></asp:imagebutton></td>
					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="idEdit" ToolTip="Edit Selected Product Package" accessKey="N" tabIndex="5" height="16" width="16" border="0" alt="Update Selected Product Package" ImageUrl="../../../_layouts/images/edit.gif" runat="server" CssClass="ms-toolbar"></asp:imagebutton></td>
					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="idBack" title="Back To Products List" accessKey="B" tabIndex="5" height="16" width="16" border="0" alt="Back To Products List" ImageUrl="../../../_layouts/images/impitem.gif" runat="server" CssClass="ms-toolbar"></asp:imagebutton></td>
			...
			<TABLE class="ms-toolbar" id="TABLE1" style="MARGIN-LEFT: 3px" cellSpacing="0" cellPadding="2" border="0" width="100%">
				<TR>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgCopyToAllMatrix" title="Copy all the above packages to all Matrix Variations" accessKey="N" tabIndex="1" height="16" width="16" border="0" alt="Copy all the above packages to all Matrix Variations" ImageUrl="../../../_layouts/images/newuser.gif" runat="server" CssClass="ms-toolbar" OnClick="imgCopyToAllMatrix_Click"></asp:imagebutton>&nbsp;
								</td>
								<td noWrap><asp:linkbutton id="cmdCopyToAllMatrix" title="Copy all the above packages to all Matrix Variations" accessKey="N" tabIndex="2" runat="server" CssClass="ms-toolbar" OnClick="cmdCopyToAllMatrix_Click">Copy all the above packages to all Matrix Variations</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					<TD class="ms-separator">
					...
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgChangePrice" title="Change price" accessKey="N" tabIndex="5" height="16" width="16" border="0" alt="Change price" ImageUrl="../../../_layouts/images/edit.gif" runat="server" CssClass="ms-toolbar" OnClick="imgChangePrice_Click"></asp:imagebutton></td>
								<td noWrap><asp:linkbutton id="cmdChangePrice" title="Change price" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" OnClick="cmdChangePrice_Click">Change Price</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					<TD class="ms-toolbar" id="TD2" noWrap align="right" width="99%"></TD>
					<td class="ms-toolbar" id="Td3" noWrap align="right"><IMG height="1" alt="" src="../../../_layouts/images/blank.gif" width="1">
					</td>
				</TR>
			</TABLE></TD>
		<td><IMG height="1" alt="" src="../../../_layouts/images/blank.gif" width="10"></td>

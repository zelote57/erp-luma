<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._Product._ProductPackage._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	...
	<BODY id="PageBody" scroll="yes" marginheight="0" marginwidth="0">
		<FORM id="frmMain" name="frmDefault" action="default.aspx" method="post" runat="server">

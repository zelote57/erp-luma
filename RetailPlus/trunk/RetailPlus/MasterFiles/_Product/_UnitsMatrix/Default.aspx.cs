...
namespace AceSoft.RetailPlus.MasterFiles._Product._UnitsMatrix
{
	...
	public partial class _Default : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			const string defaultTitle = "Product Unit Matrix";
			...
			if (Request.QueryString["task"]!=null)
			{
                ...
                long id = Convert.ToInt64(Common.Decrypt(Request.QueryString["prodid"].ToString(), Session.SessionID));
				...
				{
					case "add":
						stHeading = "Create New Unit Matrix";	

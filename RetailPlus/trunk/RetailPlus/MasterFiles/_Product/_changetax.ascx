<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._Product.__ChangeTax" Codebehind="_changetax.ascx.cs" %>
                ...
                <tr>
	                ...
	                <td class="ms-authoringcontrols" style="padding-bottom: 2px; PADDING-TOP: 10px" colspan="3">
                        <table class="ms-authoringcontrols" cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <td nowrap>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" >
                                        ...
                                        <Triggers> 
                                            ...
                                            <asp:AsyncPostBackTrigger ControlID="imgSaveTax" EventName="Click" />
                                            <asp:AsyncPostBackTrigger ControlID="cmdSaveTax" EventName="Click" />
                                        </Triggers> 
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                            ...
                            <tr >
                                <td nowrap style="PADDING-TOP: 8px"><label>Enter new VAT</label></td>
                                <td style="PADDING-TOP: 8px"> : </td>
                                <td nowrap style="PADDING-TOP: 8px">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                                        <ContentTemplate >
                                            <asp:TextBox ID="txtVAT" runat="server" AccessKey="C" BorderStyle="Groove" CssClass="ms-short-numeric">0</asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers> 
                                            <asp:AsyncPostBackTrigger ControlID="cboProductGroup" EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="cmdProductGroup" EventName="Click" />    
                            ...
                            <tr >
                                <td nowrap style="PADDING-TOP: 8px"><label>Enter new EVAT</label></td>
                                <td style="PADDING-TOP: 8px"> : </td>
                                <td nowrap style="PADDING-TOP: 8px">
                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" >
                                        <ContentTemplate >
                                            <asp:TextBox ID="txtEVAT" runat="server" AccessKey="C" BorderStyle="Groove" CssClass="ms-short-numeric">0</asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers> 
                                            <asp:AsyncPostBackTrigger ControlID="cboProductGroup" EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="cmdProductGroup" EventName="Click" />    
                            ...
                            <tr >
                                <td nowrap style="PADDING-TOP: 8px"><label>Enter new Local Tax</label></td>
                                <td style="PADDING-TOP: 8px"> : </td>
                                <td nowrap style="PADDING-TOP: 8px">
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server" >
                                        <ContentTemplate >
                                            <asp:TextBox ID="txtLocalTax" runat="server" AccessKey="C" BorderStyle="Groove" CssClass="ms-short-numeric">0</asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers> 
                                            <asp:AsyncPostBackTrigger ControlID="cboProductGroup" EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="cmdProductGroup" EventName="Click" />    
	        ...
	        <table class="ms-toolbar" id="TABLE2" cellspacing="0" cellpadding="2" border="0" width="100%">
				<tr>
                        ...
                        <asp:UpdatePanel ID="updSave" runat="server">
                            <ContentTemplate>
		                        <table cellspacing="0" cellpadding="1" border="0">
			                        <tr>
				                        <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgSaveTax" tooltip="Save Taxes to the selected group and/or subgroup and/or specific product" accessKey="S" tabIndex="1" height="16" width="16" border="0" ImageUrl="../../_layouts/images/saveitem.gif" runat="server" CssClass="ms-toolbar" OnClick="imgSaveTax_Click"></asp:imagebutton>&nbsp;
								        </td>
								        <td nowrap="nowrap"><asp:linkbutton id="cmdSaveTax" tooltip="Save Taxes to the selected group and/or subgroup and/or specific product" accessKey="S" tabIndex="2" runat="server" CssClass="ms-toolbar" OnClick="cmdSaveTax_Click">Save Taxes</asp:linkbutton></td>
			                        </tr>
		                        </table>
                            </ContentTemplate>
                        </asp:UpdatePanel>
	                ...
	                <td class="ms-toolbar">
			            <table cellspacing="0" cellpadding="1" border="0">
				            <tr>
					            <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgCancel" title="Cancel Applying Taxes" accessKey="C" tabIndex="3" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/impitem.gif" alt="Cancel Applying Taxes" border="0" width="16" height="16" CausesValidation="False" OnClick="imgCancel_Click"></asp:imagebutton></td>
					            <td nowrap="nowrap"><asp:linkbutton id="cmdCancel" title="Cancel Applying Taxes" accessKey="C" tabIndex="4" CssClass="ms-toolbar" runat="server" CausesValidation="False" onclick="cmdCancel_Click">Cancel</asp:linkbutton></td>
				            </tr>
			            </table>
		            </td>

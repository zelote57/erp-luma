			...
			<table class="ms-toolbar" style="margin-left: 0px" cellpadding="2" cellspacing="0" border="0" width="100%">
				<tr>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgDelete" ToolTip="Add New Product Group Unit" accessKey="N" tabIndex="3" CssClass="ms-toolbar" runat="server" ImageUrl="../../../_layouts/images/delitem.gif" alt="Remove Selected Product Group Unit" border="0" width="16" height="16" OnClick="imgDelete_Click"></asp:imagebutton></td>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="idEdit" ToolTip="Add New Product Group Unit" accessKey="N" tabIndex="5" CssClass="ms-toolbar" runat="server" ImageUrl="../../../_layouts/images/edit.gif" alt="Update Selected Product Group Unit" border="0" width="16" height="16" OnClick="idEdit_Click"></asp:imagebutton></td>

...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._ProductGroup._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Product Groups</title>
	...
	<body id="PageBody" scroll="yes" marginheight="0" marginwidth="0">
		<form id="frmProductGroup" name="frmProductGroup" action="default.aspx" method="post" runat="server">

<%@ Reference Page="~/masterfiles/_productsubgroup/default.aspx" %>
...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._ProductSubGroup._VariationsMatrix._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Product SubGroup Variations Matrix</title>

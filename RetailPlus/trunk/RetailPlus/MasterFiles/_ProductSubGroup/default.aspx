<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._ProductSubGroup._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Product SubGroup</title>
	...
	<BODY id="PageBody" scroll="yes" marginheight="0" marginwidth="0">
		<FORM id="frmProductSubGroup" name="frmProductSubGroup" action="default.aspx" method="post" runat="server">

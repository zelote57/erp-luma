<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._PromoBySupplier.__Insert" Codebehind="_Insert.ascx.cs" %>
	...
	<tr>
		...
		<td>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<table class="ms-authoringcontrols" style="MARGIN-BOTTOM: 5px" cellspacing="0" cellpadding="0" border="0" width="100%">
							...
							<tr>
								...
								<td class="ms-authoringcontrols" width="100%">
									<asp:TextBox id="txtPromoBySupplierCode" runat="server" accesskey="G" CssClass="ms-short" MaxLength="60" BorderStyle="Groove"></asp:TextBox>
									<asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server" CssClass="ms-error" ErrorMessage="'Promo code' must not be left blank." Display="Dynamic" ControlToValidate="txtPromoBySupplierCode" ForeColor=" "></asp:requiredfieldvalidator>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="ms-formspacer"><img alt="" src="../../_layouts/images/trans.gif" width="10" /></td>
								<td class="ms-authoringcontrols" width="100%">
									<asp:TextBox id="txtPromoBySupplierName" runat="server" accesskey="G" CssClass="ms-short" MaxLength="75" BorderStyle="Groove"></asp:TextBox>
				...
				<tr>
					<td valign="top" style="padding-bottom: 20px">
						<div class="ms-sectionheader" style="padding-bottom: 8px">Step 2:&nbsp;Date 
							coverage</div>
						<div class="ms-descriptiontext" style="padding-bottom:	10px">

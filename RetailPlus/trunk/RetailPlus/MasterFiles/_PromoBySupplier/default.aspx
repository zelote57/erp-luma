...
<%@ Register TagPrefix="CTRL" TagName="ctrlStuff" Src="_Stuff.ascx" %>
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._PromoBySupplier._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Promo Coupon's</title>
						...
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%">
									...
									<CTRL:ctrlStuff id="ctrlStuff" runat="server" Visible="False"></CTRL:ctrlStuff></td>
							</tr>
						</table>
					</td>
				</tr>

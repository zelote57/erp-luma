...
namespace AceSoft.RetailPlus.MasterFiles._Unit
{
	public partial class _Default : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			const string defaultTitle = "List of Units";
			SiteTitle.Title = defaultTitle;

			const SearchCategoryID defaultSearchIndex = SearchCategoryID.Units;
			...
			if (Request.QueryString["task"]!=null)
			{
				...
				{
					case "add":
						stHeading = "Create New Unit";	
						SearchIndex = SearchCategoryID.Units;
						ctrlInsert.Visible = true;
						break;
					case "edit":
						stHeading = "Modify Unit";
						SearchIndex = SearchCategoryID.Units;
						ctrlUpdate.Visible = true;
						break;   
					case "list":
						stHeading = "Units List";		
						SearchIndex = SearchCategoryID.Units;
						ctrlList.Visible = true;
						break;
                    case "details":
                        stHeading = "Unit details";
                        SearchIndex = SearchCategoryID.Units;

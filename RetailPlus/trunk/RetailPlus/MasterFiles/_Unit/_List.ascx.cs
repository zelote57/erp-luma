	...
	public partial  class __List : System.Web.UI.UserControl
	{
        ...
        protected void lstItem_ItemDataBound(object sender, DataListItemEventArgs e)
		{
			...
			else if(e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
                ...
                chkList.Value = dr["UnitID"].ToString();
                ...
                lnkUnitName.NavigateUrl = "Default.aspx?task=" + Common.Encrypt("details", Session.SessionID) + "&id=" + Common.Encrypt(chkList.Value, Session.SessionID);
			}
		}
		...
		private void LoadSortFieldOptions(DataListItemEventArgs e)
		{
			...
			HyperLink SortByUnitCode = (HyperLink) e.Item.FindControl("SortByUnitCode");
			HyperLink SortByUnitName = (HyperLink) e.Item.FindControl("SortByUnitName");

			SortByUnitCode.NavigateUrl = "Default.aspx" + stParam + "&sortfield=" + Common.Encrypt("UnitCode", Session.SessionID);

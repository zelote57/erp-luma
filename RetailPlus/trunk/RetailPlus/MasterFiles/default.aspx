...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.MasterFiles._Default" Codebehind="Default.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Master Files</title>
								...
								<tr>
									<td>
										<table style="padding-left: 2px; padding-TOP: 0px" cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												<td style="padding-TOP: 2px" nowrap="nowrap" align="middle" width="132" height="46"><img id="spsPageTitleIcon" alt="" src="../_layouts/images/masterfiles.gif">
												</td>

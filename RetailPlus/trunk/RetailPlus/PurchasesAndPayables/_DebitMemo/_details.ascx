<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.PurchasesAndPayables._DebitMemo.__Details" Codebehind="_Details.ascx.cs" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgPrint" title="Print this Purchase Debit Memo" accessKey="G" tabIndex="5" height="16" width="16" border="0" alt="Print this Purchase Debit Memo" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" OnClick="imgPrint_Click"></asp:imagebutton></td>
								<td noWrap><asp:linkbutton id="cmdPrint" title="Print this Purchase Debit Memo" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="cmdPrint_Click">Print</asp:linkbutton></td>
							</tr>
						</table>
					</td>
	...
	<tr>
		<td><IMG height="1" alt="" src="../../_layouts/images/blank.gif" width="10"></td>
		<TD>
            <asp:datalist id="lstItem" runat="server" Width="100%" ShowFooter="False" CellPadding="0" OnItemDataBound="lstItem_ItemDataBound">
                <HeaderTemplate>
					...
					<td vAlign="top" colSpan="3">
                        <table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
	                        <tr style="PADDING-BOTTOM: auto">
		                        ...
		                        <td align="right"><asp:textbox onkeypress="AllNum()" id="txtPODiscountApplied" accessKey="" runat="server" CssClass="ms-short-disabled" BorderStyle="Groove" Text=0 Width="82px" AutoPostBack="True" ReadOnly="True"></asp:textbox><asp:dropdownlist id="cboPODiscountType" runat="server" CssClass="ms-short-disabled" AutoPostBack="True" Enabled="False">
	                        ...
	                        <tr style="PADDING-BOTTOM: 5px">
		                        ...
		                        <td align="right"><asp:textbox onkeypress="AllNum()" id="txtPOFreight" accessKey="" runat="server" CssClass="ms-short-disabled" BorderStyle="Groove" Text="0.00" AutoPostBack="True" ReadOnly="True"></asp:textbox>
	                        ...
	                        <tr style="PADDING-BOTTOM: 5px">
		                        ...
		                        <td align="right"><asp:textbox onkeypress="AllNum()" id="txtPODeposit" accessKey="" runat="server" CssClass="ms-short-disabled" BorderStyle="Groove" Text="0.00" AutoPostBack="True" ReadOnly="True"></asp:textbox>

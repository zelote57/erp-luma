	...
	public partial  class __eList : System.Web.UI.UserControl
	{
        ...
        protected void chkIncludeIneSalesAll_CheckedChanged(Object sender, EventArgs e)
        {
            ...
            foreach (DataListItem item in lstItem.Items)
            {
                ...
                clsDebitMemos.UpdateIncludeIneSales(iDebitMemoID, chkIncludeIneSalesAll.Checked);
        ...
        protected void chkIncludeIneSales_CheckedChanged(Object sender, EventArgs e)
        {
            ...
            DebitMemos clsDebitMemos = new DebitMemos();
            clsDebitMemos.UpdateIncludeIneSales(iDebitMemoID, chkIncludeIneSales.Checked);
            clsDebitMemos.CommitAndDispose();
        }
		...
		{
			Common Common = new Common();
			string stParam = "?task=" + Common.Encrypt("list", Session.SessionID) + "&status=" + DebitMemoStatus.Posted.ToString("d");
		...
		{	
            ...
            PageData.DataSource = clsDebitMemos.SearchAsDataTable(DebitMemoStatus.Posted, dteOrderStartDate, dteOrderEndDate, dtePostingStartDate, dtePostingEndDate, SearchKey, SortField, sortoption, 0, clseSalesFilter).DefaultView; 

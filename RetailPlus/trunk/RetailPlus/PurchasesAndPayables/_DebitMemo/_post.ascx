				                ...
				                <td class="ms-authoringcontrols">
				                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:HyperLink id="lnkAddProduct" runat="server" Visible="false" ToolTip="Add new product" Target="_blank">[add new]</asp:HyperLink>
		                ...
		                <HeaderTemplate>
			                <table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblHeaderTemplate">
				                ...
				                <tr>
						            ...
						            <TH class="ms-vh2" style="padding-bottom: 4px; padding-top: 4px; text-align: right"><asp:hyperlink id="SortByPrevUnitCost" runat="server">Prev Unit Cost</asp:hyperlink></TH>
					                <TH class="ms-vh2" style="padding-bottom: 4px; padding-top: 4px; text-align: right"><asp:hyperlink id="SortByUnitCost" runat="server">Unit Cost</asp:hyperlink></TH>

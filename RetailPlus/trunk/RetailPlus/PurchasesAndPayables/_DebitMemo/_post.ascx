<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.PurchasesAndPayables._DebitMemo.__Post" Codebehind="_Post.ascx.cs" %>
	...
	<tr>
		...
		<TD>
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr style="PADDING-BOTTOM: 10px">
								...
								<td style="HEIGHT: 70px" borderColor="white" align="center" width="40%" rowSpan="3"><label class="ms-sectionheader" style="FONT-WEIGHT: bold; FONT-SIZE: 40px">Purchase 
										Debit Memo</label></td>
								<td style="PADDING-BOTTOM: 2px" width="30%" colSpan="2"><label>Purchase Memo no:</label></td>
							</tr>
							<tr style="PADDING-BOTTOM: 5px">
								<TD class="ms-formspacer"></TD>
								<TD class="ms-formspacer"></TD>
								<TD class="ms-formspacer"><IMG alt="" src="../../_layouts/images/trans.gif" width="10"></TD>
								<td style="PADDING-BOTTOM: 2px" width="30%"><asp:HyperLink id="lnkMemoNo" runat="server" CssClass="ms-error"></asp:HyperLink></td>
							</tr>
							<tr style="PADDING-BOTTOM: 5px">
								...
								<td style="PADDING-BOTTOM: 2px; HEIGHT: 52px" vAlign="top" width="30%" colSpan="2"><label>Date 
										Prepared: </label>
									<asp:label id="lblMemoDate" runat="server" CssClass="ms-error"></asp:label></td>
							</tr>
							...
							<tr style="PADDING-BOTTOM: 5px">
								...
								<TD class="ms-formspacer"><IMG alt="" src="../../_layouts/images/trans.gif" width="10"></TD>
								<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" width="30%"><asp:label id="lblRequiredPostingDate" runat="server" CssClass="ms-error"></asp:label></td>
							</tr>
							<tr>
								<td class="ms-formspacer" colSpan="6"></td>
							</tr>
							<tr style="PADDING-BOTTOM: 5px">
								<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" width="30%" colSpan="2"><label>Memo 
										from branch:</label></td>
							...
							<tr style="PADDING-BOTTOM: 5px">
								<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" width="30%" colSpan="6"><label>
										Remarks:</label><asp:label id="lblRemarks" runat="server" CssClass="ms-error"></asp:label></td>
							</tr>
						</table>
					</td>
				</TR>
									...
									<table cellSpacing="0" cellPadding="1" border="0">
										<tr>
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap><asp:imagebutton id="cmdUpdateHeader" ToolTip="Update Purchase Debit Memo Header" accessKey="E" tabIndex="5" runat="server" CssClass="ms-toolbar" ImageUrl="../../_layouts/images/edit.gif" alt="Update Purchase Debit Memo Header" border="0" width="16" height="16" OnClick="cmdUpdateHeader_Click"></asp:imagebutton></td>
														<td noWrap><asp:linkbutton id="imgUpdateHeader" ToolTip="Update Purchase Debit Memo Header" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="imgUpdateHeader_Click">Update Purchase Debit Memo Header</asp:linkbutton></td>
													</tr>
												</table>
											</td>
											...
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap><asp:imagebutton id="imgPrint" ToolTip="Print this Purchase Debit Memo" accessKey="G" tabIndex="5" height="16" width="16" border="0" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgPrint_Click"></asp:imagebutton></td>
														<td noWrap><asp:linkbutton id="cmdPrint" ToolTip="Print this Purchase Debit Memo" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" CausesValidation="False" onclick="cmdPrint_Click">Print</asp:linkbutton></td>
													</tr>
												</table>
											</td>
											...
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap><asp:imagebutton id="imgCancel" ToolTip="Cancel Adding New Item And Back To Memo List" accessKey="C" tabIndex="3" height="16" width="16" border="0" alt="Cancel Adding New Item And Back To Memo List" ImageUrl="../../_layouts/images/impitem.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgCancel_Click"></asp:imagebutton></td>
														<td noWrap><asp:linkbutton id="cmdCancel" ToolTip="Cancel Adding New Item And Back To Memo List" accessKey="C" tabIndex="4" runat="server" CssClass="ms-toolbar" CausesValidation="False" onclick="cmdCancel_Click">Back To Memo List</asp:linkbutton></td>
													</tr>
												</table>
											</td>
			                ...
			                <tr>
				                <td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" colSpan="2"><label>Select 
						                Product Code<font color="red">*
							                <asp:label id="lblDebitMemoItemID" runat="server" CssClass="ms-error" Visible="False">0</asp:label></font></label></td>
				                <td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" colSpan="2"><label>Select 
                                        ...
                                        <ContentTemplate>
					                        <table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
						                        <tr>
							                        ...
							                        <td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" colSpan="2"><label>Enter 
									                        Previous Unit Cost<font color="red">*</font></label></td>
									                <td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" colSpan="2"><label>Enter 
									                        Current Unit Cost<font color="red">*</font></label></td>
							                        <td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" colSpan="2"><label>Enter 
						                        ...
						                        <tr>
							                        ...
							                        <td class="ms-formspacer"><IMG alt="" src="../../_layouts/images/trans.gif" width="10"></td>
							                        <td class="ms-authoringcontrols"><asp:textbox onkeypress="AllNum()" id="txtPrevPrice" onkeyup="ComputeAmountPost()" accessKey="P" runat="server" CssClass="ms-short" BorderStyle="Groove">0</asp:textbox><asp:requiredfieldvalidator id="Requiredfieldvalidator13" runat="server" CssClass="ms-error" ErrorMessage="'Price' must not be left blank." Display="Dynamic" ControlToValidate="txtPrice"></asp:requiredfieldvalidator></td>
							                        <td class="ms-formspacer"><IMG alt="" src="../../_layouts/images/trans.gif" width="10"></td>
				...
				<tr>
					<td class="ms-sectionline" colSpan="3" height="1">
					    <table class="ms-toolbar" id="twotidGrpsTC" cellSpacing="0" cellPadding="2" border="0" width="100%">
							<TR>
									...
									<table cellSpacing="0" cellPadding="1" border="0">
										<tr>
											...
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap><asp:imagebutton id="imgDelete" ToolTip="Remove Selected Item" accessKey="X" tabIndex="3" height="16" width="16" border="0" alt="Remove Selected Item" ImageUrl="../../_layouts/images/delitem.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgDelete_Click"></asp:imagebutton></td>
		                ...
		                <HeaderTemplate>
			                <table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblHeaderTemplate">
				                ...
				                <TR>
						            ...
						            <TH class="ms-vh2" style="padding-bottom: 4px; padding-top: 4px" align="right">
						                <asp:hyperlink id="SortByPrevUnitCost" runat="server">Prev Unit Cost</asp:hyperlink></TH>
					                <TH class="ms-vh2" style="padding-bottom: 4px; padding-top: 4px" align="right">
						                <asp:hyperlink id="SortByUnitCost" runat="server">Unit Cost</asp:hyperlink></TH>
					                <TH class="ms-vh2" style="padding-bottom: 4px; padding-top: 4px" align="right">
		                ...
		                <ItemTemplate>
			                <TABLE id="tblItemTemplate" cellSpacing="0" cellPadding="0" width="100%" border="0" onmouseover="this.bgColor='#FFE303'" onmouseout="this.bgColor='transparent'">
				                ...
				                <TR>
					                ...
					                <TD class="ms-vb-user" align="right">
						                <asp:Label ID="lblPrevUnitCost" Runat="server"></asp:Label>
					                </TD>
					                <TD class="ms-vb-user" align="right">
                            ...
                            <ContentTemplate>
		                        <table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
			                        ...
			                        <tr style="PADDING-BOTTOM: 5px">
				                        ...
				                        <td align="right"><asp:textbox onkeypress="AllNum()" id="txtPOFreight" accessKey="" runat="server" CssClass="ms-short" BorderStyle="Groove" Text="0.00" AutoPostBack="True" OnTextChanged="txtPOFreight_TextChanged"></asp:textbox>
			                        ...
			                        <tr style="PADDING-BOTTOM: 5px">
				                        ...
				                        <td align="right"><asp:textbox onkeypress="AllNum()" id="txtPODeposit" accessKey="" runat="server" CssClass="ms-short" BorderStyle="Groove" Text="0.00" AutoPostBack="True" OnTextChanged="txtPODeposit_TextChanged"></asp:textbox>
				                                                                       <asp:requiredfieldvalidator id="Requiredfieldvalidator12" runat="server" CssClass="ms-error" ControlToValidate="txtPODeposit" Display="Dynamic" ErrorMessage="'Deposit' must not be left blank."></asp:requiredfieldvalidator></td>
			                        </tr>
			                        <tr>
				                        <TD class="ms-formspacer"></TD>
				                        <TD></TD>
			...
			<table class="ms-toolbar" id="onetidGrpsTC" style="MARGIN-LEFT: 0px" cellpadding="2" cellspacing="0" border="0" width="100%">
				<TR>
					...
					<td class="ms-toolbar" align="center">
						...
						<asp:requiredfieldvalidator id="Requiredfieldvalidator10" runat="server" CssClass="ms-error" ControlToValidate="txtPostDate" Display="Dynamic" ErrorMessage="'Memo Date' must not be left blank."></asp:requiredfieldvalidator>
						<asp:CompareValidator id="CompareValidator1" runat="server" CssClass="ms-error" ControlToValidate="txtPostDate" Display="Dynamic" ErrorMessage="'Memo Date' must be a valid date." Type="Date" Operator="DataTypeCheck"></asp:CompareValidator>
					</td>
					<TD class="ms-separator"><asp:label id="Label12" runat="server">|</asp:label></TD>
					<td class="ms-toolbar" align="center">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap>Supplier Doc No:</td>
						...
						<asp:requiredfieldvalidator id="Requiredfieldvalidator7" runat="server" CssClass="ms-error" ControlToValidate="txtSupplierDocNo" Display="Dynamic" ErrorMessage="'Memo No' must not be left blank."></asp:requiredfieldvalidator>
					</td>
					<TD class="ms-separator"><asp:label id="Label16" runat="server">|</asp:label></TD>
					<td class="ms-toolbar">
						<table cellSpacing="0" cellPadding="1" border="0">
							<tr>
								<td class="ms-toolbar" noWrap><asp:imagebutton id="imgPost" title="Post" accessKey="I" tabIndex="5" CssClass="ms-toolbar" runat="server" ImageUrl="../../_layouts/images/post.gif" alt="Post" border="0" width="16" height="16" OnClick="imgPost_Click"></asp:imagebutton></td>
								<td noWrap><asp:linkbutton id="cmdPost" title="Post" accessKey="I" tabIndex="6" CssClass="ms-toolbar" runat="server" onclick="cmdPost_Click">Post</asp:linkbutton></td>
							</tr>
						</table>
					</td>

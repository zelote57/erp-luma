...
<%@ Register TagPrefix="CTRL" TagName="ctrlPurchasesAndPayables" Src="../Reports/_PurchasesAndPayables.ascx" %>
...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.PurchasesAndPayables._Default" Codebehind="Default.aspx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RetailPlus : Purchases & Payables</title>
						...
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%">
									<CTRL:ctrlPurchasesAndPayables id="ctrlPurchasesAndPayables" runat="server" Visible="False"></CTRL:ctrlPurchasesAndPayables></td>
							</tr>
						</table>
					</td>
				</tr>

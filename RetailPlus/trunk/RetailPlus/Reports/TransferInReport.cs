...
namespace RetailPlus.Reports {
    ...
    public class TransferInReport : ReportClass {
        
        public TransferInReport() {
        }
        
        public override string ResourceName {
            get {
                return "TransferInReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "RetailPlus.Reports.TransferInReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTransferInReport : Component, ICachedReport {
        
        public CachedTransferInReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            TransferInReport rpt = new TransferInReport();
            rpt.Site = this.Site;
            return rpt;
        }

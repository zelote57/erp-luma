				...
				<tr>
					<td class="ms-authoringcontrols" valign="top" style="PADDING-RIGHT:	10px; BORDER-TOP:	white 10px solid; PADDING-LEFT:	8px; padding-bottom:	10px" colspan="3">
						<table class="ms-authoringcontrols" style="MARGIN-BOTTOM: 5px" cellspacing="0" cellpadding="0" border="0" width="100%">
							<asp:PlaceHolder id="holderValidityDate" runat="server" Visible="true">
				                <tr>
					                ...
					                <td nowrap="nowrap">
						                <asp:TextBox id="txtStartValidityDate" ondblclick="ontime(this)" accesskey="S" CssClass="ms-short" runat="server" BorderStyle="Groove" MaxLength="10" ToolTip="Double click to select date from Calendar" Width="100px"></asp:TextBox>
					                </td>
					                <td class="ms-separator">&nbsp;&nbsp;|&nbsp;&nbsp;</td>
					                <td style="padding-bottom:2px" nowrap="nowrap">
					                ...
					                <td class="ms-separator">&nbsp;&nbsp;&nbsp;</td>
					                <td nowrap="nowrap">
						                <asp:TextBox id="txtEndValidityDate" ondblclick="ontime(this)" accesskey="E" CssClass="ms-short" runat="server" BorderStyle="Groove" MaxLength="10" ToolTip="Double click to select date from Calendar" Width="100px"></asp:TextBox>
                                        &nbsp;&nbsp;
                                        <asp:Label id="Label1" CssClass="ms-error" runat="server" Font-Names="Wingdings">l</asp:Label>
						                <asp:Label id="Label5" CssClass="ms-error" runat="server"> Date must be in yyyy-mm-dd format.</asp:Label>
					                </td>
					                <td width="99%" id="Td9" nowrap="nowrap" align="left">&nbsp;
					                </td>
				                </tr>
					        </asp:PlaceHolder>
							...
							<asp:PlaceHolder id="holderTransaction" runat="server" Visible="false">
                                ...
                                <tr>
					                ...
					                <td width="99%" id="align04" nowrap="nowrap" align="right"><img height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="1">
					                </td>
				                </tr>
                                <tr>
					                <td style="padding-bottom:2px" nowrap="nowrap">
                                ...
                                <tr>
					                ...
					                <td width="99%" id="Td7" nowrap="nowrap" align="right"><img height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="1">
					                </td>
				                </tr> 
				            </asp:PlaceHolder>
                            <asp:PlaceHolder id="holderTerminaNo" runat="server" Visible="false">
                                <tr>
					                ...
					                <td width="99%" id="Td8" nowrap="nowrap" align="right"><img height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="1">
					                </td>
				                </tr>
                            </asp:PlaceHolder>

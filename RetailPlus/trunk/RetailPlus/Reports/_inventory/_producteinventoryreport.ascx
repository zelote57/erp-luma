<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.Reports.__ProducteInventoryReport" Codebehind="_producteinventoryreport.ascx.cs" %>
	...
	<tr>
		...
		<td>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td colspan="3" class="ms-sectionline" height="2"><img height="1" alt="" src="/RetailPlus/_layouts/images/empty.gif" width="1" /></td>
				</tr>
				<tr>

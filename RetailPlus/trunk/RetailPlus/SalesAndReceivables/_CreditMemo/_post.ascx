<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.SalesAndReceivables._CreditMemo.__Post" Codebehind="_Post.ascx.cs" %>
					...
					<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 5px" vAlign="top" colspan="3">
						<table class="ms-authoringcontrols" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr style="PADDING-BOTTOM: 10px">
								...
								<td style="PADDING-BOTTOM: 2px" width="30%" colspan="2"><label>CN no:</label></td>
							</tr>
							...
							<tr style="PADDING-BOTTOM: 5px">
								...
								<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" width="40%" colspan="2"><label>Telephone 
										no:</label></td>
								<td class="ms-authoringcontrols" style="PADDING-BOTTOM: 2px" width="30%" colspan="2"><label>Required Posting Date:</label></td>
							</tr>
							<tr style="PADDING-BOTTOM: 5px">
								<TD class="ms-formspacer"><IMG alt="" src="../../_layouts/images/trans.gif" width="10"></TD>
									...
									<table cellSpacing="0" cellPadding="1" border="0">
										<tr>
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap><asp:imagebutton id="cmdUpdateHeader" ToolTip="Update Credit Memo Header" accessKey="E" tabIndex="5" runat="server" CssClass="ms-toolbar" ImageUrl="../../_layouts/images/edit.gif" alt="Update Credit Memo Header" border="0" width="16" height="16" OnClick="cmdUpdateHeader_Click"></asp:imagebutton></td>
														<td noWrap><asp:linkbutton id="imgUpdateHeader" ToolTip="Update Credit Memo Header" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="imgUpdateHeader_Click">Update Credit Memo Header</asp:linkbutton></td>
													</tr>
												</table>
											</td>
											...
											<td class="ms-toolbar">
												<table cellSpacing="0" cellPadding="1" border="0">
													<tr>
														<td class="ms-toolbar" noWrap style="width: 19px"><asp:imagebutton id="imgPrint" ToolTip="Print this Credit Memo" accessKey="G" tabIndex="5" height="16" width="16" border="0" alt="Print this Credit Memo" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgPrint_Click"></asp:imagebutton></td>
														<td noWrap><asp:linkbutton id="cmdPrint" ToolTip="Print this Credit Memo" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" CausesValidation="False" onclick="cmdPrint_Click">Print</asp:linkbutton></td>
													</tr>
												</table>
											</td>

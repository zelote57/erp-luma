namespace AceSoft.RetailPlus.SalesAndReceivables._Returns
{
	...
	public partial  class __Post : System.Web.UI.UserControl
	{
        ...
        protected void imgCancel_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            Response.Redirect(Constants.ROOT_DIRECTORY + "/SalesAndReceivables/_Returns/Default.aspx?task=" + Common.Encrypt("list", Session.SessionID));
        }
        ...
        private void UpdateFreight()
        {
            SOReturnDetails clsSOReturnDetails = new SOReturnDetails();
            clsSOReturnDetails.CreditMemoID = Convert.ToInt64(lblCreditMemoID.Text);
            clsSOReturnDetails.Freight = Convert.ToDecimal(txtSOFreight.Text);

            SOReturns clsSOReturns = new SOReturns();
            clsSOReturns.UpdateFreight(clsSOReturnDetails.CreditMemoID, clsSOReturnDetails.Freight);
            clsSOReturns.SynchronizeAmount(Convert.ToInt64(lblCreditMemoID.Text));
            clsSOReturnDetails = clsSOReturns.Details(Convert.ToInt64(lblCreditMemoID.Text));
            clsSOReturns.CommitAndDispose();

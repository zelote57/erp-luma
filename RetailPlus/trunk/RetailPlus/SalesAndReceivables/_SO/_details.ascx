<%@ Control Language="c#" Inherits="AceSoft.RetailPlus.SalesAndReceivables._SO.__Details" Codebehind="_Details.ascx.cs" %>
				...
				<tr>
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgPrint" ToolTip="Print this Sales Order" accessKey="G" tabIndex="5" height="16" width="16" border="0" alt="Print this Sales Order" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" OnClick="imgPrint_Click"></asp:imagebutton></td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdPrint" ToolTip="Print this Sales Order" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="cmdPrint_Click">Print</asp:linkbutton></td>
							</tr>
						</table>
					</td>
			        ...
			        <td class="ms-toolbar">
                        <table cellspacing="0" cellpadding="1" border="0">
	                        <tr>
		                        <td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgPrintSellingPrice" ToolTip="Print this Sales Order with Selling Price" accessKey="G" tabIndex="5" height="16" width="16" border="0" alt="Print this Sales Order with Selling Price" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" onclick="imgPrintSellingPrice_Click"></asp:imagebutton></td>
		                        <td nowrap="nowrap"><asp:linkbutton id="cmdPrintSellingPrice" ToolTip="Print this Sales Order with Selling Price" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" onclick="cmdPrintSellingPrice_Click">Print With Selling Price</asp:linkbutton></td>
	                        </tr>
                        </table>
                    </td>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgPrintQuotation" ToolTip="Print this Quotation Order" accessKey="G" tabIndex="5" height="16" width="16" border="0" ImageUrl="../../_layouts/images/print.gif" runat="server" CssClass="ms-toolbar" OnClick="imgPrintQuotation_Click"></asp:imagebutton></td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdPrintQuotation" ToolTip="Print this Quotation Order" accessKey="E" tabIndex="6" runat="server" CssClass="ms-toolbar" OnClick="cmdPrintQuotation_Click">Print Quotation</asp:linkbutton></td>
							</tr>
						</table>
					</td>
					...
					<td class="ms-toolbar">
						<table cellspacing="0" cellpadding="1" border="0">
							<tr>
								<td class="ms-toolbar" nowrap="nowrap"><asp:imagebutton id="imgCancel" ToolTip="Back To SO List" accessKey="C" tabIndex="3" height="16" width="16" border="0" alt="Back To SO List" ImageUrl="../../_layouts/images/impitem.gif" runat="server" CssClass="ms-toolbar" CausesValidation="False" OnClick="imgCancel_Click"></asp:imagebutton></td>
								<td nowrap="nowrap"><asp:linkbutton id="cmdCancel" ToolTip="Back To SO List" accessKey="C" tabIndex="4" runat="server" CssClass="ms-toolbar" CausesValidation="False" onclick="cmdCancel_Click">Back To SO List</asp:linkbutton></td>
							</tr>
						</table>
					</td>

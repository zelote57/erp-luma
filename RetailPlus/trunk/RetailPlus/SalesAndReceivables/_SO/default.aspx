...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.SalesAndReceivables._SO._Default" Codebehind="Default.aspx.cs" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlMenu" Src="../../SalesAndReceivables/_Menu.ascx" %>
...
<HTML>
	<HEAD>
		<title>RetailPlus : Sales Orders</title>
		...
		<form id="frmDefaultID" name="frmDefault" action="default.aspx" method="post" runat="server">
			...
			<table class="ms-main" height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
								...
								<tr>
									<td>
										<table style="padding-left: 2px; padding-TOP: 0px" cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												<td style="padding-TOP: 2px" nowrap="nowrap" align="center" width="132" height="46"><img id="spsPageTitleIcon" alt="" src="/RetailPlus/_layouts/images/inventory.gif">
												</td>
												<td><img height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="15">
												</td>
										...
										<table cellpadding="0" cellspacing="0" border="0" width="100%">
											<tr>
												<td height="2" colspan="5"><img SRC="/RetailPlus/_layouts/images/blank.gif" width="1" height="1" alt=""></td>
											</tr>
											<tr>
												<td class="ms-titlearealine" height="1" colspan="5"><img SRC="/RetailPlus/_layouts/images/blank.gif" width="1" height="1" alt=""></td>
											</tr>
										</table>
									</td>
								</tr>
				...
				<tr valign="top" height="100%">
					...
					<td><img height="1" alt="" src="/RetailPlus/_layouts/images/blank.gif" width="5"></td>

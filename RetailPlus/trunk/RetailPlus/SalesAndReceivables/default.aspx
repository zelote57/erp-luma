...
<%@ Page language="c#" Inherits="AceSoft.RetailPlus.SalesAndReceivables._Default" Codebehind="Default.aspx.cs" %>
...
<%@ Register TagPrefix="CTRL" TagName="ctrlSalesAndReceivables" Src="../Reports/_SalesAndReceivables.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RetailPlus : Sales & Receivables</title>
				...
				<tr valign="top" height="100%">
					...
					<td class="ms-bodyareaframe" valign="top" width="100%"><CTRL:PAGELEVELERROR id="PageLevelError" runat="server"></CTRL:PAGELEVELERROR>
						<table class="ms-tztable" id="ZoneTable" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr id="TopRow">
								<td class="ms-tztop" id="TopCell" valign="top" width="100%"><CTRL:ctrlSalesAndReceivables id="ctrlSalesAndReceivables" runat="server" Visible="False"></CTRL:ctrlSalesAndReceivables></td>
							</tr>
						</table>
					</td>
				</tr>

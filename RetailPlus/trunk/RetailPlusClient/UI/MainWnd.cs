...
namespace AceSoft.RetailPlus.Client.UI
{
	public class MainWnd : MainWndExtension 
	{
		...
		private void InitializeComponent()
		{
            ...
            this.OrderSlipPrinter1,
            this.OrderSlipPrinter2,
            this.OrderSlipPrinter3,
            this.OrderSlipPrinter4,
            this.OrderSlipPrinter5,
    ...
    "sage and/or    .dasdasdas";
		...
		{
			dgStyle.GridColumnStyles["ItemNo"].Width = 60;
			dgStyle.GridColumnStyles["Description"].Width = dgItems.Width - 315;
			dgStyle.GridColumnStyles["Quantity"].Width = 85;
				...
				if (mclsSalesTransactionDetails.CustomerID == Constants.C_RETAILPLUS_CUSTOMERID)
				{
					try
					{
                        ...
                        if (!mclsTerminalDetails.ShowCustomerSelection)
                        {
                            ...
                            addwnd.Caption = "Suspend Transaction: Please Enter Customer Name";
                            addwnd.TerminalDetails = mclsTerminalDetails;

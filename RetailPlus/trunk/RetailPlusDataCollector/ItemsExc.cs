    ...
    public class InvExLog
    {
        ...
        private void WriteToWriter()
        {
            try
            {
                ...
                string logFile = logsdir + BranchDetails.BranchCode + logdate.ToString("yyyyMMdd") + "_exc.inv";
                LogFile = logFile;
                ...
                if (!File.Exists(logFile))
                {
                    ...
                    writer.WriteLine("This is an auto-generated logfile for RetailPlus inventory Data Collector InvExLog.");

...
{
	public class CreditSalesWnd : Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "CreditSalesWnd";
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Load += new System.EventHandler(this.CreditSalesWnd_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.CreditSalesWnd_KeyDown);
		...
		private void CreditSalesWnd_Load(object sender, System.EventArgs e)
		{
			try
		...
		private void CreditSalesWnd_KeyDown(object sender, KeyEventArgs e)
		{
			switch (e.KeyData)
			{
				case Keys.Escape:

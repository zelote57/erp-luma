	...
	public class EJournalPrinter
	{
		...
		private void WriteToWriter(int Counter)
		{
			try
			{
                ...
                string logsdir = System.Configuration.ConfigurationManager.AppSettings["TransactionPath"].ToString();
				...
				string logFile = logsdir + logdate.ToString("MMM") + "/" + mstFileName + ".dbg";
				if (Counter >= 1)
                    logFile = logsdir + logdate.ToString("MMM") + "/" + mstFileName + "_" + Counter.ToString("0#").ToString() + ".dbg";
                ...
                if (!File.Exists(logFile))
                {
                    ...
                    writer.WriteLine("This is an auto-generated logfile for RetailPlus Ejournal Logs.");

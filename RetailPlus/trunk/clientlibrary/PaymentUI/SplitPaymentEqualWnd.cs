...
{
	public class SplitPaymentEqualWnd : Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "SplitPaymentEqualWnd";
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Load += new System.EventHandler(this.SplitPaymentEqualWnd_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.SplitPaymentEqualWnd_KeyDown);
        ...
        private void dgItems_Click(object sender, EventArgs e)
        {
            ...
            if (ItemDataTable.Rows.Count > 0)
            {
                ...
                //clsSalesTransactionDetails.SubTotal = mclsSalesTransactionDetails.SubTotal / NoOfDiners;
                //clsSalesTransactionDetails.DiscountableAmount = mclsSalesTransactionDetails.DiscountableAmount / NoOfDiners;
                //clsSalesTransactionDetails.Discount = mclsSalesTransactionDetails.Discount / NoOfDiners;
                //clsSalesTransactionDetails.Charge = mclsSalesTransactionDetails.Charge / NoOfDiners;
                //clsSalesTransactionDetails.VAT = mclsSalesTransactionDetails.VAT / NoOfDiners;
                //clsSalesTransactionDetails.VATableAmount = mclsSalesTransactionDetails.VATableAmount / NoOfDiners;
                //clsSalesTransactionDetails.EVAT = mclsSalesTransactionDetails.EVAT / NoOfDiners;
                //clsSalesTransactionDetails.EVATableAmount = mclsSalesTransactionDetails.EVATableAmount / NoOfDiners;
		...
		private void SplitPaymentEqualWnd_Load(object sender, System.EventArgs e)
		{
		...
		private void SplitPaymentEqualWnd_KeyDown(object sender, KeyEventArgs e)
		{
			switch (e.KeyData)
			{
                case Keys.Up:
        ...
        private void LoadData()
        {
            ...
            for (Int32 iCtr = 1; iCtr < NoOfDiners + 1; iCtr++)
            {
                ...
                ItemDataTable.Rows.Add(iCtr.ToString(), (Balance / NoOfDiners).ToString("#,##0.#0"), "0.00", (Balance / NoOfDiners).ToString("#,##0.#0"), "0.00");
            }

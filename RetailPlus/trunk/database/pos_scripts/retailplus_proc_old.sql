...
BEGIN
	...
	UPDATE tblTransaction SET CustomerID = lngCustomerID, CustomerName = strCustomerName WHERE TransactionID = lngTransactionID;
...
create procedure procTerminalReportInitializeZRead(IN strTerminalNo varchar(10), IN dteDateLastInitialized DateTime, IN strInitializedBy varchar(150))
BEGIN
	...
	INSERT INTO tblTerminalReportHistory (
				...
				(SELECT 
					...
					NoOfDiscountedTransactions, NegativeAdjustments, NoOfNegativeAdjustmentTransactions,
					PromotionalItems, CreditSalesTax, BatchCounter, strInitializedBy FROM tblTerminalReport WHERE TerminalNo = strTerminalNo);

...
namespace AceSoft.RetailPlus.Data
{
	...
	public struct GLATransactionDetails
	{
	...
	[StrongNameIdentityPermissionAttribute(SecurityAction.LinkDemand,
		 ...
		 "E3696F9FACDBEA831810AE6DC9EDCA91A7B5DA12FE7BF65D113" +
		 "FF52834EAFB5A7A1FDFD5851A3")]
	public class GLATransaction : POSConnection
	{
		
		#region Constructors and Destructors

		public GLATransaction()
            : base(null, null)
        {
        }

        public GLATransaction(MySqlConnection Connection, MySqlTransaction Transaction) 
        ...
        public Int64 Insert(GLATransactionDetails Details)
		{
			try  
			{                             
        ...
        public void ProcessBatch(string BatchID)
        {
            try
            {
                string SQL = "CALL procProcessGLA(@strBatchID);";

                MySqlCommand cmd = new MySqlCommand();
                cmd.CommandType = System.Data.CommandType.Text;
                cmd.CommandText = SQL;

                cmd.Parameters.AddWithValue("@strBatchID", BatchID);
		...
		public bool Delete(string BatchID)
		{
			try 
			{
                ...
                string SQL = "DELETE FROM tblgla_f_dtl_chk_headers WHERE BatchID = '" + BatchID + "' ;";

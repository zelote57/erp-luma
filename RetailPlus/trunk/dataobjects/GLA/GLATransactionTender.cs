...
namespace AceSoft.RetailPlus.Data
{
    ...
    public struct GLATransactionTenderDetails
    {
        ...
        public decimal Tender_Total;
        public decimal Chgd_Tip_Ttl;
    ...
    [StrongNameIdentityPermissionAttribute(SecurityAction.LinkDemand,
         ...
         "E3696F9FACDBEA831810AE6DC9EDCA91A7B5DA12FE7BF65D113" +
         "FF52834EAFB5A7A1FDFD5851A3")]
    public class GLATransactionTender : POSConnection
    {

        #region Constructors and Destructors

        public GLATransactionTender()
            : base(null, null)
        {
        }

        public GLATransactionTender(MySqlConnection Connection, MySqlTransaction Discount)
        ...
        public Int64 Insert(GLATransactionTenderDetails Details)
        {
            try
            {
                string SQL = "INSERT INTO tblgla_f_dtl_chk_tmd (" +
                                    "fk_business_date," +
                                    "fk_location_def," +
                                    "fk_emp_def," +
                                    "fk_chk_headers," +
                ...
                cmd.Parameters.AddWithValue("@fk_tmd_def", Details.fk_tmd_def);
                ...
                cmd.Parameters.AddWithValue("@Tender_Count", Details.Tender_Count);
                cmd.Parameters.AddWithValue("@Tender_Total", Details.Tender_Total);
                cmd.Parameters.AddWithValue("@Chgd_Tip_Ttl", Details.Chgd_Tip_Ttl);
        ...
        public bool Delete(string BatchID)
        {
            try
            {
                string SQL = "DELETE FROM tblgla_f_dtl_chk_tmd WHERE BatchID  = '" + BatchID + "';";

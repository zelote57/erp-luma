...
namespace AceSoft.RetailPlus.Data
{
	...
	public struct OrderTenderGLADetails
	{
	...
	[StrongNameIdentityPermissionAttribute(SecurityAction.LinkDemand,
		 ...
		 "E3696F9FACDBEA831810AE6DC9EDCA91A7B5DA12FE7BF65D113" +
		 "FF52834EAFB5A7A1FDFD5851A3")]
	public class OrderTenderGLA : POSConnection
	{
		
		#region Constructors and Destructors

		public OrderTenderGLA()
            : base(null, null)
        {
        }

        public OrderTenderGLA(MySqlConnection Connection, MySqlTransaction Transaction) 
        ...
        public Int64 Insert(OrderTenderGLADetails Details)
		{
			try  
			{

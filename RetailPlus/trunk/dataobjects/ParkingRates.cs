...
namespace AceSoft.RetailPlus.Data
{
	...
	public class ParkingRate : POSConnection
    {
        ...
        public ParkingRate(MySqlConnection Connection, MySqlTransaction Transaction) 
		...
		public Int16 Save(ParkingRateDetails Details)
		{
			try 
			{
                string SQL = "CALL procSaveParkingRate(@ParkingRateID, @ProductID, @DayOfWeek, @StartTime, @EndTime, @NoOfUnitPerMin, @PerUnitPrice, @MinimumStayInMin, @MinimumStayPrice, @CreatedByName);";
                ...
                cmd.Parameters.AddWithValue("CreatedByName", Details.ParkingRateID == 0 ? Details.CreatedByName : Details.LastUpdatedByName);
        ...
        private ParkingRateDetails setDetails(System.Data.DataTable dt)
        {
            ...
            foreach (System.Data.DataRow dr in dt.Rows)
            {
                ...
                Details.LastUpdatedOn = DateTime.Parse(dr["LastUpdatedOn"].ToString());
            }

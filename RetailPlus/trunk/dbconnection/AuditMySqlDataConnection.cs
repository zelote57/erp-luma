...
{
    public abstract class AuditPOSConnection
    {
        ...
        public AuditPOSConnection()
        {
        }

        public AuditPOSConnection(MySqlConnection Connection, MySqlTransaction Transaction)
        {
        ...
        public MySqlConnection GetConnection(string ServerIP = "", string DBPort = "", string DBName = "")
        {
            ...
            {
                mConnection = new MySqlConnection(AceSoft.RetailPlus.DBConnection.AuditConnectionString(ServerIP, DBPort, DBName));
                mConnection.Open();

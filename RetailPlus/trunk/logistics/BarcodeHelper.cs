...
namespace AceSoft
{
    public class BarcodeHelper
    {
		...
		public BarcodeHelper( string mfgNumber, string productId )
		{
			this.CountryCode = "00";
		...
		public BarcodeHelper( string countryCode, string mfgNumber, string productId )
		{
        ...
        public BarcodeHelper(string countryCode, string mfgNumber, string productId, string checkDigit)
		{
			this.CountryCode = countryCode;
			this.ManufacturerCode = mfgNumber;
			this.ProductCode = productId;

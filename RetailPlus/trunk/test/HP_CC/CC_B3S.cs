...
//     <summary>
//     Summary description for CC_B3S.
//     </summary>
//    public class CC_B3S
//    {
...
//                string SQL = "SELECT LPAD(CONCAT(CC_B3S_ID,TRACER),14,'0') TransactionNo, STR_TO_DATE(TRDATE, '%d/%m/%Y') TransactionDate, " +
//                                "CONVERT(TRAMNT, DECIMAL(18,3)) SubTotal, CONCAT('888880', LPAD(CC_B3S.ICRKEY,7,0)) ContactCode, CC_B3S_ID, TRACER TracerNo " +
//                             "FROM CC_B3S WHERE isProcessed = 0 LIMIT " + iLimit.ToString() + ";";
...
//                    Int64 CC_B3S_ID = Int64.Parse(dr["CC_B3S_ID"].ToString());
...
//                    {
//                        Console.WriteLine("b3s[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " has invalid customercode: " + ContactCode + ".");
//                        iTheSame++;
//                    }
//                    else
//                    {
...
//                        if (dtT.Rows.Count > 0)
//                        {
//                            Console.WriteLine("b3s[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " already in the database.");
//                            iTheSame++;
//                        }
//                        else
//                        {
...
//                            cmd.Parameters.AddWithValue("@CashierName", "CC SysUser");
//                            cmd.Parameters.AddWithValue("@TerminalNo", strTerminalNo);
...
//                            cmd.Parameters.AddWithValue("@CreatedByName", "CC SysUser");
...
//                            cmd.Parameters.AddWithValue("@DataSource", "CC_B3S");
...
//                            Console.WriteLine("b3s[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " has been inserted.");
//                            iNotTheSame++;
//                        }
...
//                            cmd.Parameters.AddWithValue("@Amount", SubTotal);
//                            cmd.Parameters.AddWithValue("@ContactID", clsContactDetails.ContactID);
//                            cmd.Parameters.AddWithValue("@Remarks", "CC payment tracer:" + TracerNo);
...
//                            cmd.Parameters.AddWithValue("@CreditReason", "CC payment tracer:" + TracerNo);
//                            cmd.Parameters.AddWithValue("@TerminalNo", strTerminalNo);
//                            cmd.Parameters.AddWithValue("@CashierName", clsSalesTransactionDetails.CashierName);
...
//                        SQL = "UPDATE CC_B3S SET isProcessed=1 WHERE CC_B3S_ID = @CC_B3S_ID;";

//                        cmd.Parameters.Clear();
//                        cmd.Parameters.AddWithValue("@CC_B3S_ID", CC_B3S_ID);

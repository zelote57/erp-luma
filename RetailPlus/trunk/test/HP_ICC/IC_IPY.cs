...
//    /// <summary>
//    /// Summary description for IC_IPY.
//    /// </summary>
//    public class IC_IPY
//    {
...
//                string SQL = "SELECT LPAD(CONCAT(IC_IPY_ID,TRACER),14,'0') TransactionNo, STR_TO_DATE(TRDATE, '%d/%m/%Y') TransactionDate, " +
//                                "(CONVERT(TRAMNT, DECIMAL(18,3)) + CONVERT(PAID_P, DECIMAL(18,3))) SubTotal, CONVERT(PAID_P, DECIMAL(18,3)) Penalty, " +
//                                "CONCAT('800000', LPAD(IC_IPY.ICRKEY,7,0)) ContactCode, IC_IPY_ID, TRACER TracerNo, ICDESC, TREFNO " +
//                             "FROM IC_IPY WHERE isProcessed = 0 LIMIT " + iLimit.ToString() + ";";
...
//                    Int64 IC_IPY_ID = Int64.Parse(dr["IC_IPY_ID"].ToString());
...
//                    {
//                        Console.WriteLine("ipy[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " has invalid customercode: " + ContactCode + ".");
//                        iTheSame++;
//                    }
//                    else
//                    {
...
//                        if (dtT.Rows.Count > 0)
//                        {
//                            Console.WriteLine("ipy[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " already in the database.");
//                            iTheSame++;
//                        }
//                        else
//                        {
...
//                            cmd.Parameters.AddWithValue("@DataSource", "IC_IPY");
...
//                            Console.WriteLine("ipy[" + iCtr.ToString() + "/" + iCount.ToString() + "]TransactionNo: " + TransactionNo + " has been inserted.");
//                            iNotTheSame++;
//                        }
...
//                        SQL = "UPDATE IC_IPY SET isProcessed=1 WHERE IC_IPY_ID = @IC_IPY_ID;";

//                        cmd.Parameters.Clear();
//                        cmd.Parameters.AddWithValue("@IC_IPY_ID", IC_IPY_ID);
...
//                //SQL = "UPDATE tblCashPayment SET SyncID = CashPaymentID WHERE SyncID = 0;";
//                //cmd.Parameters.Clear();
//                //cmd.CommandText = SQL;
//                //clsLocalConnection.ExecuteNonQuery(cmd);
